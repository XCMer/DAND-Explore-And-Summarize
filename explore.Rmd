...
I'll first plot the correlations between all variables. This will help me inspect the right ones. I'll only look at values that are >= 0.25 in either direction.
