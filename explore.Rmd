...
1. Given fixed acidity, citric and volatile acidity are somewhat redundant. The relationship is not exactly linear, which would be the only reason to still keep citric and volatile acidity in the dataset.
...
Observation:
1. No direct relation between fixed acidity and quality observed
...
```
Observation
1. Both quality 3 and 8 wines have lower values of residual sugar. So residual sugar is not alone a strong indicator of quality.
...
1. I found no strong correlation between quality and a few features that I examined.
...
3. Thus, fixed.acidity describes a lot of what citric.acid and volatile.acidity describe together, making citric.acid and volatile.acidity somewhat redundant.

### What was the strongest relationship you found?

The relationship between fixed.acidity, citric.acid and volatile.acidity was the strongest that I found.
